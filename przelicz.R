wartosci <- c("2-3 razy dziennie" = 2.5*30,
              "1 raz dziennie" = 30,
              "1 w miesiącu" = 1,
              "1 w tygodniu" = 4,
              "2-3 razy w miesiącu" = 2.5,
              "2-3 razy w tygodniu" = 4*2.5,
              "4-5 razy w tygodniu" = 4*4.5,
              "6 razy w tygodniu" = 4*6,
              "Nigdy" = 0,
              "Rzadziej niż 1 raz w miesiącu" = 1/3,
